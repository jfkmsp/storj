...
class APIKeyInfo {
	...
	static fromJSON(v unknown): APIKeyInfo {
...
class BucketUsageRollup {
	...
	static fromJSON(v unknown): BucketUsageRollup {
...
class CreateAPIKeyRequest {
	...
	static fromJSON(v unknown): CreateAPIKeyRequest {
...
class CreateAPIKeyResponse {
	...
	static fromJSON(v unknown): CreateAPIKeyResponse {
...
class Project {
	...
	static fromJSON(v unknown): Project {
		let o = new Project()
		o.id = v.id
		o.name = v.name
...
class ProjectInfo {
	...
	static fromJSON(v unknown): ProjectInfo {
...
class ResponseUser {
	...
	static fromJSON(v unknown): ResponseUser {
